# VMAX Linux-Only Reverse Engineering & Next Phase Investigation Report
...
- **Dual Engine Architecture**: `Vmax.exe` contains **two distinct display/communication stacks**:
  1. `AICDisp` (`DeviceCommunicationLibrary.dll`) $ightarrow$ Serial CDC telemetry/asset MCU (`33c3:f101` at `/dev/ttyACM0`).
  2. `MSDisplay` (`MSDISPLAYSDKWRRAPER.dll`) $ightarrow$ Native MacroSilicon USB video display driver (`345f:9132`, `345f:9133`, `345f:374a`, `345f:a101`).
