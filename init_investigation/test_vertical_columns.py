...
def generate_vertical_grid_jpeg():
    ppm_path = "/tmp/vertical_grid.ppm"
    jpg_path = "/tmp/vertical_grid.jpg"
    
    img = Image.new('RGB', (WIDTH, HEIGHT), (0, 0, 0))
    draw = ImageDraw.Draw(img)
    
    # 4 Vertical Columns across 640px width (each 160px wide)
    # 4 Horizontal Rows across 1920px height (each 480px tall)
    # 16 distinct colored blocks
...
def main():
    ...
    unbind_cdc_acm()
    jpeg_bytes = generate_vertical_grid_jpeg()
    print(f"=== Vertical Column & 4x4 Grid Test (JPEG size: {len(jpeg_bytes)} B) ===")
    print("  Column 1 (Left 0-160)   : Red, Yellow, Orange, Dark Red")
    print("  Column 2 (MidL 160-320) : Green, Cyan, Mint, Dark Green")
    print("  Column 3 (MidR 320-480) : Blue, Magenta, Purple, Dark Blue")
    print("  Column 4 (Right 480-640): White, Gray, Yellow-White, Light Gray")
