...
def create_cjpeg_frame(text="HELLO WORLD"):
    ...
    draw.text((60, 1400), "VMAX CJPEG NATIVE", fill=(220, 100, 255), font=font_md)
    draw.text((60, 1520), "640x1920 cjpeg", fill=(255, 255, 255), font=font_lg)
...
def main():
    ...
    print(f"=== cjpeg Driver Test ({len(jpeg_bytes)} B JPEG) ===")
