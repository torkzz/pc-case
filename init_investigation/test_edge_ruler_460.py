...
def generate_edge_ruler_460_jpeg():
    jpg_path = "/tmp/edge_ruler_460x1920.jpg"
    img = Image.new('RGB', (WIDTH, HEIGHT), (15, 20, 35))
    draw = ImageDraw.Draw(img)
    
    try:
        font = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf", 20)
        font_lg = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf", 34)
    except Exception:
        font = font_lg = ImageFont.load_default()

    # Title
    draw.text((60, 60), "460px EDGE RULER", fill=(0, 220, 255), font=font_lg)
    ...
    # RIGHT EDGE RULER (X = 380 to 459)
    right_markers = [380, 390, 400, 410, 420, 430, 440, 450, 459]
    ...
    # Center Marker
    draw.line([(230, 0), (230, HEIGHT)], fill=(255, 255, 255), width=2)
    draw.text((200, 500), "C230", fill=(255, 255, 255), font=font)
...
def main():
    ...
    unbind_cdc_acm()
    jpeg_bytes = generate_edge_ruler_460_jpeg()
    print(f"=== 460px EDGE RULER DIAGNOSTIC (460x1920) ===")
